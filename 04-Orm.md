...
| defaultScriptingLanguage         | 指定动态 SQL 生成使用的默认脚本语言。                                                                                                                                                                                                                                                    | 一个类型别名或全限定类名。                         | org.apache.ibatis.<br />scripting.xmltags.<br />XMLLanguageDriver |
| defaultEnumTypeHandler           | 指定 Enum 使用的默认`Typdl                                                                                                                                                                                                                                                               |                                                    |                                                                   |
| eHaner` 。（新增于 3.4.5）       | 一个类型别名或全限定类名。                                                                                                                                                                                                                                                               | org.apache.<br />ibatis.type.<br />EnumTypeHandler |                                                                   |
